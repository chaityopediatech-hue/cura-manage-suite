...
return ( <div className="max-w-3xl mx-auto flex flex-col h-[calc(100vh-9rem)]"> <div className="flex items-center gap-2 mb-3"> <Bot className="h-5 w-5 text-primary" /> <h1 className="text-2xl font-semibold">{t("assistant")}</h1> </div>
